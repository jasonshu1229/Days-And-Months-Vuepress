 ...
 *
 * @param {*} obj 要检测的实例
 * @param {*} constructor 要检测的构造函数/类
 * @returns Boolean 返回当前实例是否属于所属类的实例
 */
function _instanceof(obj, constructor) {
  // 对 constructor 的校验：不能是原始值，必须是有 prototype 的 function
  if (constructor === null || !/^(object|function)$/.test(typeof constructor))
  ...
  // 首先检测 constructor 是否拥有 Symbol.hasInstance 方法
  ...
  // 按照原型链查找，是否会出线 constructor.prototype
